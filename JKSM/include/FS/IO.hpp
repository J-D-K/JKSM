...
namespace FS
{
    // This recursively copies Source to Destination. Progress task is so the progress can be shown to the user. Commit is false by default. This needs to be true for User and System saves.
    void CopyDirectoryToDirectory(System::ProgressTask *Task, const FsLib::Path &Source, const FsLib::Path &Destination, bool Commit);
